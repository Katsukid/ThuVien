...
-->
 ...
 <img alt="Đĩa quang" class="format" src="/opac-tmpl/lib/famfamfam/cd.png" />
 </xsl:if>
 <xsl:if test="$cf007ss11 = 'c' and $cf007ss21 = 'r'">
 available online <img src="/opac-tmpl/lib/famfamfam/drive_web.png" alt="remote" class="format"/>
 </xsl:if>
 ...
 <img alt="Biểu đồ" class="format" src="/opac-tmpl/lib/famfamfam/chart_curve.png" />
 </xsl:if>
 <xsl:if test="$cf007ss11 = 'k' and $cf007ss21 = 'c'">
 Tranh dán </xsl:if>
 <xsl:if test="$cf007ss11 = 'k' and $cf007ss21 = 'd'">
 <img alt="Tranh họa tiết" class="format" src="/opac-tmpl/lib/famfamfam/pencil.png" />
 </xsl:if>
 <xsl:if test="$cf007ss11 = 'k' and $cf007ss21 = 'o'">
 <img alt="Thẻ nhớ" class="format" src="/opac-tmpl/lib/famfamfam/note.png" />
 </xsl:if>
 <xsl:if test="$cf007ss11 = 'k' and $cf007ss21 = 'e'">
 <img alt="Tranh vẽ" class="format" src="/opac-tmpl/lib/famfamfam/paintbrush.png" />
 </xsl:if>
 ...
 <img alt="Ảnh" class="format" src="/opac-tmpl/lib/famfamfam/picture.png" />
 </xsl:if>
 ...
 <img alt="Ký hiệu âm nhạc" class="format" src="/opac-tmpl/lib/famfamfam/script.png" />
 </xsl:if>
 ...
 <img alt="Đĩa nhạc" class="format" src="/opac-tmpl/lib/famfamfam/cd.png" />
 </xsl:if>
 ...
 <img alt="In khổ lớn" class="format" src="/opac-tmpl/lib/famfamfam/magnifier.png" />
 </xsl:if>
...
<xsl:if test="$DisplayOPACiconsXSLT!='0'">
 ...
 <xsl:choose>
 <xsl:when test="$leader19='a'"><img alt="Bộ" class="materialtype mt_icon_ST" src="/opac-tmpl/lib/famfamfam/ST.png" /> Bộ</xsl:when>
 <xsl:when test="$leader6='a'">
 <xsl:choose>
 <xsl:when test="$leader7='c' or $leader7='d' or $leader7='m'"><img alt="Văn bản" class="materialtype mt_icon_BK" src="/opac-tmpl/lib/famfamfam/BK.png" /> Văn bản</xsl:when>
 ...
 <xsl:when test="$leader7='a' or $leader7='b'"><img alt="Bài báo" class="materialtype mt_icon_AR" src="/opac-tmpl/lib/famfamfam/AR.png" /> Bài báo</xsl:when>
 </xsl:choose>
 </xsl:when>
 <xsl:when test="$leader6='t'"><img alt="Văn bản" class="materialtype mt_icon_BK" src="/opac-tmpl/lib/famfamfam/BK.png" /> Văn bản</xsl:when>
 <xsl:when test="$leader6='o'"><img alt="Bộ công cụ" class="materialtype mt_icon_MM" src="/opac-tmpl/lib/famfamfam/MM.png" /> Bộ công cụ</xsl:when>
 <xsl:when test="$leader6='p'"><img alt="Vật liệu hỗn hợp" class="materialtype mt_icon_MM" src="/opac-tmpl/lib/famfamfam/MM.png" />Vật liệu hỗn hợp</xsl:when>
 <xsl:when test="$leader6='m'"><img alt="File máy tính" class="materialtype mt_icon_CF" src="/opac-tmpl/lib/famfamfam/CF.png" /> File máy tính</xsl:when>
 <xsl:when test="$leader6='e' or $leader6='f'"><img alt="Bản đồ" class="materialtype mt_icon_MP" src="/opac-tmpl/lib/famfamfam/MP.png" /> Bản đồ</xsl:when>
 <xsl:when test="$leader6='g'"><img src="/opac-tmpl/lib/famfamfam/VM.png" alt="Film" class="materialtype mt_icon_VM"/> Film</xsl:when>
 <xsl:when test="$leader6='k'"><img alt="Ảnh" class="materialtype mt_icon_GR" src="/opac-tmpl/lib/famfamfam/GR.png" /> Ảnh</xsl:when>
 <xsl:when test="$leader6='r'"><img alt="Đối tượng" class="materialtype mt_icon_OB" src="/opac-tmpl/lib/famfamfam/OB.png" /> Đối tượng</xsl:when>
 <xsl:when test="$leader6='c' or $leader6='d'"><img alt="Phạm vi" class="materialtype mt_icon_PR" src="/opac-tmpl/lib/famfamfam/PR.png" /> Phạm vi</xsl:when>
 <xsl:when test="$leader6='i'"><img alt="Âm nhạc" class="materialtype mt_icon_MU" src="/opac-tmpl/lib/famfamfam/MU.png" /> Âm nhạc</xsl:when>
 <xsl:when test="$leader6='j'"><img alt="Âm nhạc" class="materialtype mt_icon_PR" src="/opac-tmpl/lib/famfamfam/PR.png" /> Âm nhạc</xsl:when>
 </xsl:choose>
 </span>
 </xsl:if>
 ...
 <img alt="Cơ sở dữ liệu" class="format" src="/opac-tmpl/lib/famfamfam/database.png" />
 </xsl:when>
 ...
 Tiểu sử <img alt="Tiểu sử" class="natureofcontents" src="/opac-tmpl/lib/famfamfam/text_list_bullets.png" />
 </xsl:when>
 ...
 <img alt="Báo cáo kỹ thuật" class="natureofcontents" src="/opac-tmpl/lib/famfamfam/report.png" />
 </xsl:when>
 ...
 <img alt="Phông chữ" class="format" src="/opac-tmpl/lib/famfamfam/font.png" />
 </xsl:when>
 <xsl:when test="$controlField008-26='g'">
 <img alt="Trò chơi" class="format" src="/opac-tmpl/lib/famfamfam/controller.png" />
 </xsl:when>
 </xsl:choose>
 </span>
 </xsl:if>
 ...
 <img alt="Hồi ký, tiểu sử" class="natureofcontents" src="/opac-tmpl/lib/famfamfam/user.png" />
 </xsl:if>
...
<xsl:text> </xsl:text> <!-- added blank space to fix font display problem, see Bug 3671 -->
 ...
 <status english="Checked out">Được ghi mượn</status>
 <status english="Withdrawn">Loại khỏi lưu thông</status>
 <status english="Lost">Bị mất thẻ</status>
 <status english="Damaged">Bị hư hỏng</status>
 <status english="Pending hold">Pending hold</status>
 <status english="In transit">Đang vận chuyển</status>
 <status english="Hold waiting">Đặt mượn</status>
 ...
 <span class="AvailabilityLabel"><strong><xsl:text>Tài liệu sẵn sàng cho mượn: </xsl:text></strong></span>
 ...
 <span class="AvailabilityLabel"><strong><xsl:text>(Các) Tài liệu sẵn sàng cho tham khảo: </xsl:text></strong></span>
