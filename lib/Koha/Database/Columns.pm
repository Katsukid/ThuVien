...
sub columns {
    return {
        ...
        borrowers => {
            ...
            "B_address"                   => __("Địa chỉ thay thế: Address"),
            "B_address2"                  => __("Địa chỉ thay thế: Address 2"),
            "B_city"                      => __("Địa chỉ thay thế: City"),
            "B_country"                   => __("Địa chỉ thay thế: Country"),
            "B_email"                     => __("Địa chỉ thay thế: Email"),
            "B_phone"                     => __("Địa chỉ thay thế: Phone"),
            "B_state"                     => __("Địa chỉ thay thế: State"),
            "B_streetnumber"              => __("Địa chỉ thay thế: Street number"),
            "B_streettype"                => __("Địa chỉ thay thế: Street type"),
            "B_zipcode"                   => __("Địa chỉ thay thế: ZIP/Postal code"),
