 ...
 * Pitfalls:
 ...
 <span class="label">Ngày đăng ký tác quyền:</span>
 </xsl:when>
 </xsl:choose>
 ...
 <xsl:with-param name="class">Số ISBN</xsl:with-param>
 <xsl:with-param name="label">Số ISBN: </xsl:with-param>
 </xsl:call-template>
 <xsl:call-template name="showSingleSubfield">
 <xsl:with-param name="tag">022</xsl:with-param>
 <xsl:with-param name="code">a</xsl:with-param>
 <xsl:with-param name="class">Số ISSN</xsl:with-param>
 <xsl:with-param name="label">Số ISSN: </xsl:with-param>
 </xsl:call-template>
 </xsl:template>
 ...
 <xsl:with-param name="langLabel">Ngôn ngữ: </xsl:with-param>
 </xsl:call-template>
 <xsl:call-template name="show-lang-node">
