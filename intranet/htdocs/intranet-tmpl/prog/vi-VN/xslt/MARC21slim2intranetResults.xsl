...
-->
 ...
 <p class="author"><span class="byAuthor">Tác giả </span>
...
<xsl:if test="$DisplayIconsXSLT!='0'">
 ...
 <xsl:choose>
 <xsl:when test="$leader19='a'"><img alt="Sách" class="materialtype" src="/intranet-tmpl/prog/img/famfamfam/silk/book_link.png" title="Sách" /> Bộ</xsl:when>
 <xsl:when test="$leader6='a'">
 <xsl:choose>
 <xsl:when test="$leader7='c' or $leader7='d' or $leader7='m'"><img alt="Sách" class="materialtype mt_icon_BK" src="/intranet-tmpl/prog/img/famfamfam/silk/book.png" title="Sách" /> Văn bản</xsl:when>
 <xsl:when test="$leader7='i' or $leader7='s'"><img alt="ÂPĐK" class="materialtype mt_icon_CR" src="/intranet-tmpl/prog/img/famfamfam/silk/newspaper.png" title="ÂPĐK" /> Continuing resource</xsl:when>
 <xsl:when test="$leader7='a' or $leader7='b'"><img alt="Bài báo" class="materialtype mt_icon_AR" src="/intranet-tmpl/prog/img/famfamfam/silk/book_open.png" title="Bài báo" /> Bài báo</xsl:when>
 </xsl:choose>
 </xsl:when>
 <xsl:when test="$leader6='t'"><img alt="Sách" class="materialtype mt_icon_BK" src="/intranet-tmpl/prog/img/famfamfam/silk/book.png" title="Sách" /> Văn bản</xsl:when>
 <xsl:when test="$leader6='o'"><img alt="Bộ công cụ" class="materialtype mt_icon_MX" src="/intranet-tmpl/prog/img/famfamfam/silk/report_disk.png" title="Bộ công cụ" /> Bộ công cụ</xsl:when>
 <xsl:when test="$leader6='p'"><img alt="Vật liệu hỗn hợp" class="materialtype mt_icon_MX" src="/intranet-tmpl/prog/img/famfamfam/silk/report_disk.png" title="Vật liệu hỗn hợp" />Vật liệu hỗn hợp</xsl:when>
 <xsl:when test="$leader6='m'"><img alt="File máy tính" class="materialtype mt_icon_CF" src="/intranet-tmpl/prog/img/famfamfam/silk/computer_link.png" title="File máy tính" /> File máy tính</xsl:when>
 <xsl:when test="$leader6='e' or $leader6='f'"><img alt="Bản đồ" class="materialtype mt_icon_MP" src="/intranet-tmpl/prog/img/famfamfam/silk/map.png" title="Bản đồ" /> Bản đồ</xsl:when>
 ...
 <xsl:when test="$leader6='k'"><img alt="Ảnh" class="materialtype mt_icon_GR" src="/intranet-tmpl/prog/img/famfamfam/silk/picture.png" /> Ảnh</xsl:when>
 <xsl:when test="$leader6='r'"><img alt="Đối tượng" class="materialtype mt_icon_OB" src="/intranet-tmpl/prog/img/famfamfam/silk/object.png" title="Đối tượng" /> Đối tượng</xsl:when>
 <xsl:when test="$leader6='c' or $leader6='d'"><img alt="Phạm vi" class="materialtype mt_icon_PR" src="/intranet-tmpl/prog/img/famfamfam/silk/music.png" title="Phạm vi" /> Phạm vi</xsl:when>
 <xsl:when test="$leader6='i'"><img alt="Âm nhạc" class="materialtype mt_icon_MU" src="/intranet-tmpl/prog/img/famfamfam/silk/sound.png" title="Âm nhạc" /> Âm nhạc</xsl:when>
 <xsl:when test="$leader6='j'"><img alt="Âm nhạc" class="materialtype mt_icon_MU" src="/intranet-tmpl/prog/img/famfamfam/silk/sound.png" title="Âm nhạc" /> Âm nhạc</xsl:when>
 </xsl:choose>
 </span>
 </xsl:if>
...
<xsl:text> </xsl:text> <!-- added blank space to fix font display problem, see Bug 3671 -->
 ...
 <span class="results_summary suppressed_opac">Được bỏ qua trong OPAC</span>
 </xsl:if>
 </xsl:if>
